...
import com.hikuley.model.Book;
import com.hikuley.service.BookService;
...
public class BookServiceTest {
    ...
    public void testFindByAuthor() {
        ...
        bookList.add(new Book("1008", "Spring Boot + MongoDB", "hikuley", "25-FEB-2017"));
        ...
        Page<Book> byAuthor2 = bookService.findByAuthor("hikuley", new PageRequest(0, 10));
